...
<section class="relative w-full min-h-screen overflow-hidden">
    <div class="absolute inset-0">
        ...
        <svg id="heroMobileA" class="hero-svg active block md:hidden min-h-full" viewBox="0 0 758 1465" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <image 
            href="./images/domsluzeib_bg_mobile.png"
            class="animate-heroReveal"
            />
