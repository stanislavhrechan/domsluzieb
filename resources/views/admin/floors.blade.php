...
<div class="p-4 md:p-8">
    <div class="flex md:flex-row flex-col gap-3 md:gap-0 md:items-center justify-between mb-8">
        <div>
            <h1 class="text-white text-2xl font-semibold">{{ $building->name }} / Poshodie</h1>
...
<div class="p-5 border border-white/10 bg-white/5">
    ...
    <div class="flex items-center justify-between mb-5">
        ...
        <div>
            ...
            <p class="text-xs text-white/40">
                {{ $floor->apartments->count() }} apartments
            </p>
        </div>

        <button
            onclick="openApartmentModal({{ $floor->id }})"
            class="px-3 py-2 bg-white text-black text-xs font-medium cursor-pointer"
        >
            + Apartment
        </button>
    ...
    <div class="space-y-2">
        ...
        <div class="p-3 bg-black/30 border border-white/5">
